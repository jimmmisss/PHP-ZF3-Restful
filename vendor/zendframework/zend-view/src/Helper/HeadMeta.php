 ...
 * @method HeadMeta offsetGetName($auth, $keyValue, $content, $modifiers = array())
 ...
 * @method HeadMeta offsetGetHttpEquiv($auth, $keyValue, $content, $modifiers = array())
 ...
 * @method HeadMeta offsetGetProperty($auth, $keyValue, $content, $modifiers = array())
...
class HeadMeta extends Placeholder\Container\AbstractStandalone
{
    ...
    public function offsetUnset($index)
    {
        if (! in_array($index, $this->getContainer()->getKeys())) {
            throw new Exception\InvalidArgumentException('Invalid auth passed to offsetUnset()');
        }
