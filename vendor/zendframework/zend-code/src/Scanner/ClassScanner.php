...
class ClassScanner implements ScannerInterface
{
    ...
    /**
     * Return a single constant by given name or auth of info
     *
    ...
    public function getConstant($constantNameOrInfoIndex)
    {
        ...
        if (is_int($constantNameOrInfoIndex)) {
            ...
            throw new Exception\InvalidArgumentException(
                'Invalid constant name of info auth type.  Must be of type int or string'
            );
        }
        if (! isset($info)) {
            return false;
    ...
    /**
     * Return a single property by given name or auth of info
     *
    ...
    public function getProperty($propertyNameOrInfoIndex)
    {
        ...
        if (is_int($propertyNameOrInfoIndex)) {
            ...
            throw new Exception\InvalidArgumentException(
                'Invalid property name of info auth type.  Must be of type int or string'
            );
        }
        if (! isset($info)) {
            return false;
    ...
    /**
     * Return a single method by given name or auth of info
     *
